    ...
    def extract(self, link: str, **kwargs) -> None:
        try:
            ...
            for result in results:
                ...
                summary = result.find("p", class_="card__summary").text.strip()
                
                # Store basic info
                result_data = {"title": title, "url": url, "summary": summary, "chapters": []}
            ...
            print(f"Completed extraction of {len(results)} guidelines with all chapters")
