...
def finetune(
    ...
    EOS_TOKEN = tokenizer.eos_token  # noqa
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base_model_name", type=str, default="unsloth/Meta-Llama-3.1-8B"
    )
    ...
    sft_output_model_repo_id = (
        f"{args.model_output_huggingface_workspace}/PharmAssist-{base_model_suffix}"
    )
    save_model(
        model,
        tokenizer,
