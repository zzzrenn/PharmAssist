...
class DataFormatter:
    ...
    def get_system_prompt(cls, data_type: str) -> str:
        return (
            f"I will give you batches of contents of {data_type}. Please generate me exactly 1 question for each of them. The {data_type} text "
            f"for which you have to generate the questions is under Content number x lines. Please structure the answer in json format,"
